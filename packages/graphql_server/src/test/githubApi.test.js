...
function testGetRepositoryTopics(githubToken) {
    return __awaiter(this, void 0, void 0, function () {
        var noTopicsResponse, otherLanguageResponse, expectedOtherLanguageTopics, nonExistentRepoResponse, manyCategoriesResponse, expectedManyCategories, emptyParamsResponse;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    // Case: No topics
                    console.log('Case: No topics');
                    return [4 /*yield*/, (0, githubApi_1.getRepositoryTopics)('AntonOsika', 'gpt-engineer', githubToken)];
                case 1:
                    ...
                    return [4 /*yield*/, (0, githubApi_1.getRepositoryTopics)('HqWu-HITCS', 'Awesome-Chinese-LLM', githubToken)];
                case 2:
                    otherLanguageResponse = _a.sent();
                    expectedOtherLanguageTopics = ['llm', 'nlp', 'chatglm', 'chinese', 'llama', 'awesome-lists'];
                    console.log(JSON.stringify(otherLanguageResponse) === JSON.stringify(expectedOtherLanguageTopics)
                        ? 'Pass'
                        : 'Fail'); // Logs whether the response matches the expected topics (Pass) or not (Fail)
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, githubApi_1.getRepositoryTopics)('AI4Finance-Foundation', 'FinGPT', githubToken)];
                case 4:
                    ...
                    console.log(JSON.stringify(manyCategoriesResponse) === JSON.stringify(expectedManyCategories)
                        ? 'Pass'
                        : 'Fail'); // Logs whether the response matches the expected categories (Pass) or not (Fail)
        ...
        return __generator(this, function (_12) {
            switch (_12.label) {
                case 0:
                    ...
                    _b = (_a = console).log;
                    _c = ['Actual:'];
                    return [4 /*yield*/, (0, githubApi_1.getContributorCount)('desktop', 'desktop', githubToken)];
                case 1:
                    ...
                    _e = (_d = console).log;
                    _f = ['Actual:'];
                    return [4 /*yield*/, (0, githubApi_1.getContributorCount)('microsoft', 'AI-For-Beginners', githubToken)];
                case 2:
                    ...
                    _h = (_g = console).log;
                    _j = ['Actual:'];
                    return [4 /*yield*/, (0, githubApi_1.getContributorCount)('Zeqiang-Lai', 'DragGAN', githubToken)];
                case 3:
                    ...
                    _l = (_k = console).log;
                    _m = ['Actual:'];
                    return [4 /*yield*/, (0, githubApi_1.getContributorCount)('geohot', 'tinygrad', githubToken)];
                case 4:
                    ...
                    _p = (_o = console).log;
                    _q = ['Actual:'];
                    return [4 /*yield*/, (0, githubApi_1.getContributorCount)('facebook', 'react', githubToken)];
                case 5:
                    ...
                    _s = (_r = console).log;
                    _t = ['Actual:'];
                    return [4 /*yield*/, (0, githubApi_1.getContributorCount)('spacedriveapp', 'spacedrive', githubToken)];
                case 6:
                    ...
                    _v = (_u = console).log;
                    _w = ['Actual:'];
                    return [4 /*yield*/, (0, githubApi_1.getContributorCount)('iam-abbas', 'Reddit-Stock-Trends', githubToken)];
                case 7:
                    ...
                    _y = (_x = console).log;
                    _z = ['Actual:'];
                    return [4 /*yield*/, (0, githubApi_1.getContributorCount)('GeneralMills', 'pytrends', githubToken)];
                case 8:
                    ...
                    _1 = (_0 = console).log;
                    _2 = ['Actual:'];
                    return [4 /*yield*/, (0, githubApi_1.getContributorCount)('vitalets', 'github-trending-repos', githubToken)];
                case 9:
                    ...
                    _4 = (_3 = console).log;
                    _5 = ['Actual:'];
                    return [4 /*yield*/, (0, githubApi_1.getContributorCount)('mbadry1', 'Trending-Deep-Learning', githubToken)];
                case 10:
                    ...
                    _7 = (_6 = console).log;
                    _8 = ['Actual:'];
                    return [4 /*yield*/, (0, githubApi_1.getContributorCount)('QasimWani', 'LeetHub', githubToken)];
                case 11:
                    ...
                    _10 = (_9 = console).log;
                    _11 = ['Actual:'];
                    return [4 /*yield*/, (0, githubApi_1.getContributorCount)('datawrangling', 'trendingtopics', githubToken)];
                case 12:
